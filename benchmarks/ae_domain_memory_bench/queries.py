...
_ELC = [
    ...
    _q("ELC-005", "electrical_contracting", "Which customer asked about a panel replacement and grounding electrode work?", ["entity","sparse","graph"]),
...
_SPA = [
    ...
    _q("SPA-028", "spanish_whatsapp", "Busca notas donde se menciona GFCI en Espanol.", ["sparse","multilingual_dense"]),
...
_MAT = [
    ...
    _q("MAT-030", "materials_sku", "Find memory about GFCI breaker versus outlet choice.", ["sparse","procedural","materials"]),
    ...
    _q("MAT-037", "materials_sku", "What memory mentions permit stickers or labels?", ["sparse","dense"]),
...
_LOT = [
    ...
    _q("LOT-015", "lennar_lots", "Which lot had a missing GFCI?", ["entity","sparse"]),
    ...
    _q("LOT-035", "lennar_lots", "Find Lennar lot note involving permit office.", ["entity","sparse","temporal"]),
...
_FIN = [
    ...
    _q("FIN-018", "financial_calendar", "Find cost notes for EV charger installation.", ["financial","materials","entity"]),
