...
Usage (run as module from project root):
    ...
    python3 -m benchmarks.mazemaker_benchmark.runner --dry-run
    python3 -m benchmarks.mazemaker_benchmark.runner --suite retrieval
    python3 -m benchmarks.mazemaker_benchmark.runner --list

    # Full benchmark
    python3 -m benchmarks.mazemaker_benchmark.runner

    # Generate report from last results
    python3 -m benchmarks.mazemaker_benchmark.report
"""
...
BENCH_ROOT = THIS_FILE.parent          # mazemaker_benchmark/
